...
var global         = __webpack_require__(2)
  ...
  , anInstance     = __webpack_require__(17)
  , isObject       = __webpack_require__(3)
...
var _electron = __webpack_require__(91);

var _installReactHook = __webpack_require__(47);
...
function mappingDomToNodeIdChildren(parent, children, getReactElementFromNative) {
    ...
    if (children && children.length > 0) {
        children.forEach(function (next, index) {
            ...
            try {
                var reactComponent = getReactElementFromNative(parent.children[index]);
...
var messageHandler = {
    ...
    setDocumentNodeIdOnce: function setDocumentNodeIdOnce(_ref2) {
        var root = _ref2.root;
    ...
    setChildNodeIdOnce: function setChildNodeIdOnce(_ref3) {
        var parentId = _ref3.parentId,
            payloads = _ref3.payloads;
...
// 23.1 Map Objects
module.exports = __webpack_require__(20)('Map', function(get){
...
// 23.2 Set Objects
module.exports = __webpack_require__(20)('Set', function(get){
...
var $WeakMap = module.exports = __webpack_require__(20)('WeakMap', wrapper, methods, weak, true, true);
...
$export($export.P + $export.R, 'Map', {toJSON: __webpack_require__(37)('Map')});
...
$export($export.P + $export.R, 'Set', {toJSON: __webpack_require__(37)('Set')});
